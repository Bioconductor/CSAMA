...
\begin{frame}{Approach 2: enrichment score}
  \begin{columns}
    ...
    \end{enumerate}
    \column{.5\textwidth}
    \includegraphics[width=\textwidth]{lec17-figs/subramanian-F1-part.jpg}
...
\begin{frame}{Approach 3: category $t$-test}
  \begin{columns}
    ...
    \end{enumerate}
    \column{.5\textwidth}
    \includegraphics[width=\textwidth]{lec17-figs/Category-ribosome.png}
...
\begin{frame}{Approach 5: issues with sequence data?}
  \begin{columns}
    ...
    \end{itemize}
    \column{.5\textwidth}
    \includegraphics[width=\textwidth]{lec17-figs/young-et-al-gb-2010-11-2-r14-2-cropped.png}
