...
\title{19.1: Gene Set Enrichment -- Introduction}
...
\begin{frame}{Approach 2: enrichment score}
  \begin{columns}
    ...
    \end{enumerate}
    \column{.5\textwidth}
    \includegraphics[width=\textwidth]{lecture-19-our-figures/subramanian-F1-part.jpg}
...
\begin{frame}{Approach 3: category $t$-test}
  \begin{columns}
    ...
    \end{enumerate}
    \column{.5\textwidth}
    \includegraphics[width=\textwidth]{lecture-19-our-figures/Category-ribosome.png}
...
\begin{frame}{Approach 5: issues with sequence data?}
  \begin{columns}
    ...
    \end{itemize}
    \column{.5\textwidth}
    \includegraphics[width=\textwidth]{lecture-19-our-figures/young-et-al-gb-2010-11-2-r14-2-cropped.png}
