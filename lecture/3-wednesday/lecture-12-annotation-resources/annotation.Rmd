...
<div>
- add HUGO gene symbols to RNA-Seq results.
</div>
<div>
...
- *annopkg* is the annotation package (or object)
...
- *Task*: annotate these to HUGO symbols.
</div>
...
- OK, but now we don't get all results...
...
- Get sequences for previously extracted transcripts.
