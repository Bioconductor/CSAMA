...
knitr::include_graphics("lecture-11-figures/mapping.png")
...
This is an example of a ChipDb
```{r, warning = FALSE}

library(hugene20sttranscriptcluster.db)
load("lecture-11-data/eset.Rdata")
set.seed(12345)
...
## But using `select` and `mapIds` are not how one normally uses them...


<iframe src="https://giphy.com/embed/l0HlKrB02QY0f1mbm" width="380" height="170" frameBorder="0" class="giphy-embed" allowFullScreen></iframe><p><a href="https://giphy.com/gifs/colbertlateshow-stephen-colbert-wait-l0HlKrB02QY0f1mbm">via GIPHY</a></p>
...
head(genes(Homo.sapiens, columns = c("ENTREZID","ALIAS","UNIPROT")),3)

```

## Limitation... there are only 3

<iframe src="https://giphy.com/embed/3oriNW27pn33u8rtuw" width="480" height="350" frameBorder="0" class="giphy-embed" allowFullScreen></iframe><p><a href="https://giphy.com/gifs/wall-brick-3oriNW27pn33u8rtuw">via GIPHY</a></p>
...
species/build. There are many such packages - you can get a listing using `available.genomes`
...
<iframe src="https://giphy.com/embed/3xz2BGZYViMYP69ft6" width="480" height="384" frameBorder="0" class="giphy-embed" allowFullScreen></iframe><p><a href="https://giphy.com/gifs/cheezburger-loop-deja-vu-3xz2BGZYViMYP69ft6">via GIPHY</a></p>
...
We will talk more about AnnotationHub when we talk about BiocFileCache in a different lecture. 
