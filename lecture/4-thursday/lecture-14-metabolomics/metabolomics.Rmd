...
<div>
- Alignment: adjust differences in retention times between samples.
</div>
<div>
- Why? Chromatography setup, age of the column, column gets dirty...
- Result: same analyte may elute at different time between measurements.
</div>
