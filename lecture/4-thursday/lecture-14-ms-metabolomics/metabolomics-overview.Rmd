...
<div>
  - plant and food metabolomics: polyphenoles, ...
</div>
<div>
...
<div>
- External influence: food, urine, dust (environment/exposome) ...
</div>
<div>
...
<div>
- External influence: food, urine, stool samples, dust ...
</div>
<div>
- Cell culture experiments:
  - supernatant: what did cells consume/produce?
  - cell extracts: insights in mitochondrial metabolism.
...
<div>
<img src="images/LC-MS-example.gif" width = 700>
</div>


## | **Liquid Chromatography Mass Spectrometry (LC-MS)** {.notransition}

Signal along retention time axis (chromatogram): m/z for [M+Na]+ ion of
*C6H12O6*.
...
exploring and analyzing LC-MS using *Spectra* and *xcms*.
</div>
</div>
