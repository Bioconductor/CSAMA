...
<!--
     ...
     reqlibs = sub(".*library\\(\"(.*?)\"\\).*","\\1",grep("library\\(",readLines("rnaseqGene_CSAMA2017.Rmd"),value=TRUE))
...
reads/fragments. This is important for the statistical models used by *DESeq2* and *edgeR* to
...
external data, that is part of the `r Biocexptpkg("airway2")` package.
...
TODO: remove this section, or update to talk about IHW?
...
TODO: cut this section, move to ensembldb lab?

<https://github.com/Bioconductor/CSAMA/blob/2018/lab/4-thursday/lab-03-Annotation/annotation-with-ensembldb.Rmd>
