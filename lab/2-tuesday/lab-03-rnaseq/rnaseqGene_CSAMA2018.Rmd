...
release 75 [@Flicek2014Ensembl] human reference genome. In the following 
code example, it is assumed that there is a file in the current
...
the *p* values at a low value, say 0.05? With *DESeq2*, there are
...
is using Gaussian processes [@Tonner2017].
