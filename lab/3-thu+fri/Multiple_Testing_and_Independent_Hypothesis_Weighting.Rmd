---
title: "Multiple Testing and Independent Hypothesis Weighting"
subtitle: "Teaching lab for CSAMA 2022"
author: "Nikos Ignatiadis, Wolfgang Huber"
output:
  BiocStyle::html_document:
    toc: true
bibliography: Multiple_Testing_and_Independent_Hypothesis_Weighting.bib 
---

<!-- 
WH adapted this file (with minimal changes) from the vignette of the IHW package (current release version) on 2022-06-13
-->

```{r setup, echo = FALSE}
knitr::opts_chunk$set(tidy = FALSE, cache = TRUE, autodep = TRUE, dev = c("png"), dpi = 360)
```
