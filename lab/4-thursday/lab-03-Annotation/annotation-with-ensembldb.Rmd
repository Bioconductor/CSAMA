...
Another rather interesting task could be to search for genes/transcripts that
encode a specific protein domain. For the present data set we could for example
search for genes that can encode for a steroid receptor binding domain.

+ Get all genes encoding any receptor binding domain.
+ Check if we have one of those in the top table, if not, can we access the full
  data?
