...
# Working with The Cancer Genome Atlas

This section introduces methods specific to working with TCGA
from the `r Biocpkg("TCGAutils")` package. 
...
also available in `r BiocStyle::Biocpkg("TCGAutils")`.
