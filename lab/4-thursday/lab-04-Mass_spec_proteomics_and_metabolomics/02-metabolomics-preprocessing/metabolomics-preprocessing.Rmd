...
too (such as `yamss` [@Myint:2017fp]), this workshop focuses on `xcms`
[@Smith:2006ic] and uses the functionality of its new user interface. In
...
detection using the *matched filter* algorithm [@Smith:2006ic].
...
```{r faahKO-correspondence, message = FALSE}
...
```{r faahKO-fillChromPeaks, message = FALSE}
...
```{r faahKO-fillChromPeaks-compare, message = FALSE}
...
```{r faahKO-PCA, message = FALSE, fig.align = "center", fig.width = 8, fig.height = 8, fig.cap = "PCA for the faahKO data set, un-normalized intensities."}
...
```{r solution-exercise-4, results = "hide", message = FALSE, eval = FALSE}
...
```{r solution-exercise-5, results = "hide", message = FALSE, eval = FALSE}
